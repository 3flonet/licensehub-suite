...
Route::prefix('v1')->group(function () {
    ...
    Route::get('/settings/site', function () {
        return app(\App\Settings\SiteSettings::class)->toArray();
    });
    ...
    Route::post('/support/contact', [\App\Http\Controllers\Api\SupportController::class, 'contact'])->middleware('throttle:5,1');

    // --- Promotions ---
    Route::post('/promos/validate', [\App\Http\Controllers\Api\PromoCodeController::class, 'validateCode'])->middleware('throttle:5,1');

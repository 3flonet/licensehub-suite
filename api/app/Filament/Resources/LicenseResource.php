        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('order.id')
                    ...
                    ->size('xs')
                    ->limit(8)
                    ->url(fn (License $record): ?string => $record->order_id ? \App\Filament\Resources\OrderResource::getUrl('edit', ['record' => $record->order_id]) : null),
                ...
                ActionGroup::make([
                    Action::make('sendEmail')
                        ...
                        ->action(function (License $record) {
                            try {
                                Mail::to($record->customer->email)->send(new LicenseIssuedMailable($record));
                                Notification::make()
                    ...
                    Action::make('copyMessage')
                        ...
                        ->color('success')
                        ->extraAttributes(fn (License $record): array => [
                            'onclick' => "navigator.clipboard.writeText(" . json_encode($record->getFormattedMessage()) . ")",
                        ])
                        ->action(function () {
                            Notification::make()
            ...
            ->bulkActions([
                Tables\Actions\BulkActionGroup::make([
                    ...
                    Tables\Actions\ExportBulkAction::make()
                        ->exporter(\App\Filament\Exporters\LicenseExporter::class),

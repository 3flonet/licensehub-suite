        ...
        return $form
            ->schema([
                ...
                Forms\Components\Textarea::make('short_description')
                    ...
                    ->placeholder('Brief summary for the product list')
                    ->maxLength(255)
                    ->helperText('Maksimal 255 karakter. Muncul pada halaman daftar produk.')
                    ->columnSpanFull(),
                ...
                Forms\Components\FileUpload::make('images')
                    ...
                    ->maxSize(4096)
                    ->helperText('Upload multiple screenshots of your product. Max 4MB per image.')
                    ->columnSpanFull(),

...
<body>
    <div class="container">
        ...
        <div class="license-box">
            <div style="font-size: 10px; color: #666; margin-bottom: 5px; font-weight: bold; letter-spacing: 1px;">LICENSE KEY</div>
            <div class="license-key" style="color: #f26522;">{{ $license->license_key }}</div>
        </div>

        <div class="license-box" style="margin-top: -10px; background: #fff; border-color: #eee;">
            <div style="font-size: 10px; color: #666; margin-bottom: 5px; font-weight: bold; letter-spacing: 1px;">PRODUCT SECRET KEY</div>
            <div class="license-key" style="font-size: 16px; color: #333;">{{ $product->api_secret }}</div>
        </div>

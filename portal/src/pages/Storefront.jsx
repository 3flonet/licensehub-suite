  ...
  return (
    <div className="max-w-7xl mx-auto p-8">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-extrabold mb-4">Digital Products</h1>
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Choose the best digital software solution for your needs. Professional tools for professional results.
        </p>
      </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  {product.short_description || (product.description?.length > 160 ? product.description.substring(0, 160) + '...' : product.description)}
                </p>
              </div>
              <div className="flex flex-wrap gap-4 text-sm font-medium items-center">
                ...
                {product.documentation_url && (
                  <a href={product.documentation_url} target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-primary hover:underline cursor-pointer">
                    Docs
                  </a>
                )}
                {product.preview_url && (
                  <a href={product.preview_url} target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-primary hover:underline cursor-pointer flex items-center gap-1">

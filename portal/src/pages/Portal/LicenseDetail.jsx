        ...
        <div className="md:col-span-2">
          ...
          <div className="mt-6 p-4 bg-muted/50 rounded-lg border border-border">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Copy the License Key and paste it into the "Activation" or "Installer" section of your <b>{license.product?.name}</b> application. The system will automatically register your domain here.
            </p>
          </div>
        </div>
      </div>
